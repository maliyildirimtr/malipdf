        ...
        <div className="download__panel">
          ...
          <div className="download__content">
            ...
            <div className="download__buttons">
              {/* macOS — choose Apple Silicon or Intel */}
              <div className="download__platform">
                <DownloadMenu
                  platform={downloads.macos}
                  tone="navy"
                  className="download__menu"
                  buttonClassName="btn btn--primary-navy btn--lg download__btn"
                  ariaLabel={`${downloads.macos.label}, version ${downloads.version} — choose Apple Silicon or Intel`}
                >
                ...
                <span className="download__meta">
                  {downloads.macos.assets
                    .map((asset) => `${asset.label} ${asset.sizeLabel}`)
                    .join(' · ')}
                </span>
              </div>
              ...
              <div className="download__platform">
                <a
                  ...
                  aria-label={`${downloads.windows.label}, version ${downloads.version} (${windowsInstaller.label}, ${windowsInstaller.sizeLabel})`}
                >
                ...
                <span className="download__meta">
                  {windowsInstaller.label} · {windowsInstaller.sizeLabel}
                </span>
              </div>
            </div>
