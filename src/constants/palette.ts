export const FIXED_PALETTE = [
  '#000000', '#7F0000', '#3E3E00', '#003E00', '#003E3E', '#00007F', '#3E003E', '#3E3E3E',
  ...
  '#FFBFFF', '#FFE0BF', '#FFFFBF', '#BFFFBF', '#BFFFFF', '#BFDFFF', '#FFBFFF', '#F0F0F0',
  '#FFDFFF', '#FFF0DF', '#FFFFDF', '#DFFFDF', '#DFFFFF', '#DFEFFF', '#FFDFFF', '#FFFFFF'
] as const;
